...
export class ChatSocketController{
    ...
    @SubscribeMessage('chat:sendMessage')
     async sendMessage(@MessageBody() message:SendMessageDto,@ConnectedSocket() client : Socket){
        ...
        await this.sendMessageUseCase.sendMessage(message.content,message.senderid);
    }
